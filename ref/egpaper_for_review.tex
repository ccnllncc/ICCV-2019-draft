...
%%%%%%%%% TITLE
\title{Visual Query Answering with Graph Matching and Reasoning}
...
%%%%%%%%% ABSTRACT
\begin{abstract}
Visual Query Answering (\vqa) is of great significance in offering people convenience: one can raise a question for details of objects, or high-level understanding about the scene, over an image. 
